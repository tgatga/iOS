...
public class BulletinInterfaceFactory {
    ...
    public func makeTitleLabel(reading title: String) -> UILabel {
        ...
        titleLabel.font = UIFont.systemFont(ofSize: titleFontSize, weight: UIFont.Weight.medium)
    ...
    public func makeActionButton(title: String) -> ContainerView<HighlightButton> {
        ...
        actionButton.titleLabel?.font = UIFont.systemFont(ofSize: actionButtonFontSize, weight: UIFont.Weight.semibold)
